  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: '#0A0908' }}>
      <div className="rounded-2xl p-8 w-full max-w-sm text-center"
        ...
        <p className="text-sm mb-8" style={{ color: '#9A9188' }}>Admin Panel</p>

        <button onClick={signInWithGoogle}
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl font-medium transition-all hover:opacity-90"
        ...
        <p className="text-xs mt-6" style={{ color: '#9A9188' }}>
